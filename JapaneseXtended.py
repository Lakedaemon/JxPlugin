...
file = os.path.join(mw.config.configPath, "plugins", "JLPT.Word.List.csv")
file_pickle = os.path.join(mw.config.configPath, "plugins", "Word2Data.pickle")
...
file = os.path.join(mw.config.configPath, "plugins", "KanjiFrequencyWikipedia.csv")
...
file = os.path.join(mw.config.configPath, "plugins", "CorpusInternet.csv")
